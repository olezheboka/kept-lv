...
export default function EditPartyPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const name = partyData.name as any || {};

                setFormData({
                    name: name.lv || name.en || "", // Assuming single string or simplified usage for now based on new page
                    slug: partyData.slug || "",
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const payload = {
                name: formData.name, // The API likely expects a string or map depending on implementation, sticking to simple string for name update for now as per new page
