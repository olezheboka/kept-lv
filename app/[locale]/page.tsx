                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight text-balance">
                                Sekojam līdzi Latvijas politiķu <span className="bg-[linear-gradient(180deg,#9E1B34_0%,#9E1B34_50%,#ffffff_50%,#ffffff_60%,#9E1B34_60%,#9E1B34_100%)] bg-clip-text text-transparent decoration-clone pb-2 drop-shadow-sm">solījumiem</span>.
                            </h1>
