                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        >
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight text-balance">
                                Sekojam līdzi <span className="bg-[linear-gradient(180deg,#9E1B34_0%,#9E1B34_59%,#ffffff_59%,#ffffff_70%,#9E1B34_70%,#9E1B34_100%)] bg-clip-text text-transparent decoration-clone pb-2">Latvijas</span> politiķu solījumiem.
                            </h1>
