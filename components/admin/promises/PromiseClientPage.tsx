                ...
                <Table>
                    ...
                    <TableBody>
                        {paginatedPromises.map((promise) => {
                            ...
                            if (promise.status === "PENDING") statusBadgeClass = "bg-blue-500 text-white hover:bg-blue-600 border-transparent";
                            ...
                            const statusLabel = promise.status === 'PARTIAL' ? 'Partially Kept' :
