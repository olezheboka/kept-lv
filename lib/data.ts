...
export const promises: Promise[] = [
  ...
  },
  {
    ...
    statusUpdatedBy: 'Kept Analytics Team',
    category: 'security',
    description: 'Ar šo apņemšanos Latvija mērķtiecīgi stiprina savas aizsardzības spējas un apliecina uzticību NATO sabiedrotajiem, novirzot būtisku daļu budžeta valsts drošībai ģeopolitiski saspringtā situācijā.',
  ...
  },
  {
    ...
    statusUpdatedBy: 'Kept Analytics Team',
    category: 'healthcare',
    description: 'Lai uzlabotu veselības aprūpes pieejamību, tiek solīts ieviest sistēmu, kas garantē katram iedzīvotājam iespēju saņemt ģimenes ārsta konsultāciju ne vēlāk kā 48 stundu laikā pēc pieteikšanās.',
  ...
  },
  {
    ...
    description: 'Stratēģiski nozīmīgā Rail Baltica dzelzceļa projekta pabeigšana savienos Latviju ar Eiropas dzelzceļa tīklu, veicinot ekonomisko izaugsmi, mobilitāti un drošību reģionā.',
  ...
  },
  {
    ...
    statusUpdatedBy: 'Kept Analytics Team',
    category: 'economy',
    description: 'Būtiska PVN samazināšana pamata pārtikas grozam ir vērsta uz pārtikas cenu stabilizēšanu un atbalstu mazāk aizsargātajām iedzīvotāju grupām augstas inflācijas apstākļos.',
  ...
  },
  {
    ...
    statusUpdatedBy: 'Kept Analytics Team',
    category: 'education',
    description: 'Lai atvieglotu vecāku ikdienu un nodrošinātu bērniem kvalitatīvu pirmsskolas izglītību, tiek solīts izveidot ievērojamu skaitu jaunu vietu bērnudārzos visā Latvijā.',
  ...
  },
  {
    ...
    description: 'Pāreja uz atjaunojamajiem energoresursiem ir solis pretī Latvijas enerģētiskajai neatkarībai un klimata mērķu sasniegšanai, palielinot zaļās enerģijas īpatsvaru kopējā patēriņā.',
  ...
  },
  {
    ...
    statusUpdatedBy: 'Kept Analytics Team',
    category: 'economy',
    description: 'Minimālās algas celšana ir vērsta uz strādājošo ienākumu nevienlīdzības mazināšanu un sociālās labklājības celšanu, nodrošinot godīgāku atalgojumu zemāk atalgotajiem darbiniekiem.',
  ...
  },
  {
    ...
    statusUpdatedBy: 'Kept Analytics Team',
    category: 'digital',
    description: 'Digitālās veselības kartes ieviešana modernizēs veselības aprūpes sistēmu, ļaujot iedzīvotājiem un ārstiem ērti un droši piekļūt medicīniskajiem datiem vienuviet.',
  ...
  },
  {
    ...
    statusUpdatedBy: 'Kept Analytics Team',
    category: 'justice',
    description: 'Korupcijas apkarošanas stiprināšana ir prioritāte tiesiskuma nodrošināšanā, tāpēc tiek solīts ievērojami palielināt atbildīgās iestādes finansējumu un darbības spējas.',
  ...
  },
  {
    ...
    statusUpdatedBy: 'Kept Analytics Team',
    category: 'education',
    description: 'Pāreja uz mācībām tikai valsts valodā ir solis uz vienotu un saliedētu sabiedrību, nodrošinot vienlīdzīgas izglītības un nākotnes karjeras iespējas visiem Latvijas jauniešiem.',
  ...
  },
  {
    ...
    description: 'Lai veicinātu paaudžu nomaiņu un modernizāciju lauksaimniecībā, tiek solīts ievērojams finansiāls starts jaunajiem uzņēmējiem laukos.',
  ...
  },
  {
    ...
    description: 'Pensiju indeksācijas pārskatīšana ir nepieciešama, lai senioru ienākumi neatpaliktu no dzīves dārdzības pieauguma un tiktu saglabāta viņu pirktspēja.',
  ...
  },
  {
    ...
    statusUpdatedBy: 'Kept Analytics Team',
    category: 'security',
    description: 'Politisks solījums saglabāt brīvprātības principu valsts aizsardzībā, fokusējoties uz profesionālo armiju un Zemessardzes stiprināšanu obligātā dienesta vietā.',
  ...
  },
  {
    ...
    statusUpdatedBy: 'Kept Analytics Team',
    category: 'regional',
    description: 'Vērienīgas investīcijas reģionos paredzētas, lai mazinātu attīstības atšķirības starp Rīgu un pārējo Latviju, uzlabojot infrastruktūru un dzīves vidi.',
  ...
  },
  {
    ...
    description: 'Solidarizējoties ar Ukrainu, Latvija apņemas atvērt savu tirgu ukraiņu ražotājiem, veicinot abu valstu ekonomisko sadarbību un sniedzot atbalstu kara plosītajai valstij.',
  ...
  },
  {
    ...
    statusUpdatedBy: 'Kept Analytics Team',
    category: 'education',
    description: 'Universāla bezmaksas ēdināšana skolās ir sociālā atbalsta instruments, kas nodrošina visiem bērniem veselīgu uzturu neatkarīgi no ģimenes materiālā stāvokļa.',
  ...
  },
  {
    ...
    statusUpdatedBy: 'Kept Analytics Team',
    category: 'digital',
    description: 'Pilnīga valsts pakalpojumu digitalizācija padarīs valsts pārvaldi efektīvāku, pieejamāku un ērtāku iedzīvotājiem, samazinot birokrātiju.',
...
export interface RankingItem {
  ...
  isInCoalition?: boolean; // Only for party
}
